export const socialPl = {
  ...
  noResults: "Nie znaleźliśmy publicznych profili o tej nazwie.", loading: "Wczytywanie…", invite: "Zaproś znajomego", inviteHint: "Wyślij swój link lub kod. Działa też przy prywatnym profilu. Ty decydujesz, czy przyjąć zaproszenie.",
  ...
  friendshipHint: "Po przyjęciu zaproszenia oboje zobaczycie swoje statystyki, ulubione filmy i porównanie gustu, także przy prywatnym profilu. Aktywność pokażemy zgodnie z ustawieniami każdej osoby.",
  signIn: "Zaloguj się, aby dodać znajomego lub obserwować", saved: "Zapisano zmianę.", feed: "Co oglądają znajomi", feedHint: "Ostatnio oznaczone jako obejrzane u znajomych i obserwowanych osób. To wpisy z kolekcji, nie podgląd seansu na żywo.",
  emptyFeed: "Gdy ktoś udostępni nowy obejrzany film, zobaczysz go tutaj.", watched: "Oznaczono jako obejrzany", rated: "Oceniono film", rating: "Ocena", refresh: "Odśwież", activity: "Ostatnio obejrzane", filmProfile: "Profil filmowy",
...
export const socialEn: SocialCopy = {
  ...
  noResults: "No public profiles match that name.", loading: "Loading…", invite: "Invite a friend", inviteHint: "Share your link or code. It works with a private profile too. You decide whether to accept each request.",
  ...
  friendshipHint: "Accepting a request lets both of you see each other's stats, favourites and taste comparison, even on private profiles. Activity follows each person's visibility settings.",
  signIn: "Sign in to add friends or follow", saved: "Change saved.", feed: "What friends are watching", feedHint: "Films recently marked as watched by friends and people you follow. These are collection entries, not live viewing activity.",
  emptyFeed: "When someone shares a newly watched film, it will appear here.", watched: "Marked as watched", rated: "Rated a film", rating: "Rating", refresh: "Refresh", activity: "Recently watched", filmProfile: "Film profile",

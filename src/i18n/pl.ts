...
const pl: Translations = {
  ...
  game: {
    mobile: {
      navigation: "Panel filmu dnia",
      guesses: "Próby",
      hints: "Wskazówki",
      revealed: "Odkryte",
      chooseGuess: "Przełącz próbę",
      showGuess: (attempt, title) => `Próba ${attempt}: ${title}`,
      latestGuess: "Ostatnia próba",
      checking: "Sprawdzanie filmu…",
      accepted: (attempt) => `Próba ${attempt} zapisana`,
      duplicate: (attempt) => `Ten film jest już w próbie ${attempt}. Nie tracisz kolejnej.`,
      newHint: "Nowa wskazówka",
      hintAfter: (attempt) => `Odkryjesz po ${attempt}. próbie`,
      revealedHelp: "Wszystkie trafione cechy szukanego filmu w jednym miejscu.",
      emptyTitle: "Jaki film obstawiasz?",
      emptyHelp: "Wpisz tytuł i wybierz film z listy. Tutaj od razu zobaczysz porównanie.",
      exact: "Trafione",
      partial: "Blisko",
      miss: "Nietrafione",
      higher: "Szukana wartość jest wyższa",
      lower: "Szukana wartość jest niższa",
      saveError: "Nie udało się potwierdzić zapisu. Odśwież stan gry przed kolejną próbą.",
      reload: "Odśwież",
    },
    back: "Powrót",
    dailyMovie: "Film dnia",

...
const en: Translations = {
  ...
  result: {
    ...
    dayStreak: (count) => `${count} day${count === 1 ? "" : "s"} in a row`,
    streakSaved: "Today's game keeps your streak alive.",
    bestStreak: (count) => `Best streak: ${count} days`,
    yourRanking: "Your result",
    betterThan: (percent) => `Better than ${percent}% of today's players`,
    calculatingResult: "Comparing your result with other players…",
    playersToday: (count) => `${count} player${count === 1 ? "" : "s"} today`,
    answerDistribution: "Answer distribution",
    missedShort: "X",
    tomorrowTitle: "Tomorrow on Showle",
    tomorrowHint: (decade, genre) => `A ${decade}s ${genre.toLowerCase()} film`,
    tomorrowMystery: "A new movie mystery is just around the corner",
    comeBackTomorrow: "Come back after midnight to keep your streak alive.",

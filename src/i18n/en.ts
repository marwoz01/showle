...
const en: Translations = {
  ...
  duel: {
    ...
    correctAnswer: (points) => `Correct! +${points}`,
  ...
  game: {
    mobile: {
      navigation: "Daily movie panel",
      guesses: "Guesses",
      hints: "Hints",
      revealed: "Revealed",
      chooseGuess: "Switch guess",
      showGuess: (attempt, title) => `Guess ${attempt}: ${title}`,
      latestGuess: "Latest guess",
      checking: "Checking movie…",
      accepted: (attempt) => `Guess ${attempt} saved`,
      duplicate: (attempt) => `Already submitted as guess ${attempt}. No extra guess used.`,
      newHint: "New hint",
      hintAfter: (attempt) => `Unlocks after guess ${attempt}`,
      revealedHelp: "All matching clues about the mystery movie in one place.",
      emptyTitle: "What's your guess?",
      emptyHelp: "Type a title and select a movie. Its comparison will appear right here.",
      exact: "Match",
      partial: "Close",
      miss: "No match",
      higher: "The answer's value is higher",
      lower: "The answer's value is lower",
      saveError: "Could not confirm your guess was saved. Reload the game before trying again.",
      reload: "Reload",
    },
    back: "Back",
    dailyMovie: "Daily Movie",
  ...
  result: {
    ...
    openProvider: (name: string) => `Open ${name}`,
